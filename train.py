...
for e in range(episode_count):
    ...
    # Save models
    agent.model.save(f"models - {agent_type}/model_ep" + str(e))
    agent.target_model.save(f"models - {agent_type}/model_target_ep"+str(e))

plt.figure()
total_rewards_df.cumsum().plot()
plt.savefig(f'results/{agent_type} strategy returns.png')
